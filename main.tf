...
locals {
  ...
  alarm_name = var.alarm_name == null ? "${local.domain_name_snake}ElasticSearch${var.statistic}${var.metric_name}${var.comparison}${var.threshold}In${var.evaluation_periods}PeriodsOf${var.period}" : var.alarm_name
}
